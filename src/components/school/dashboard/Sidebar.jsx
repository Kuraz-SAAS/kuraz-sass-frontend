  ...
  return (
    <div>
      ...
      <aside
        ...
        } fixed md:hidden top-0 left-0 w-64 h-full p-2 bg-white shadow-lg transition-transform duration-300 ease-in-out z-50`}
      >
        {/* Hamburger Menu Icon */}
          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="font-light text-sm">Grades</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="font-light text-sm">Subjects</span>
              </NavLink>
            </li>
            <li>
              <NavLink
            ...
            <li>
              ...
              >
                <FaUserGraduate className="text-green-400 mr-2" />
                <span className="font-light text-sm">Students</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="font-light text-sm">Notices</span>
              </NavLink>
            </li>
          </ul>
        </div>
      ...
      <aside
        className={`hidden md:block md:relative top-0 left-0 w-64 h-full p-2 bg-white shadow-lg transition-transform duration-300 ease-in-out z-50`}
      >
        {/* Hamburger Menu Icon */}
        <div className="flex justify-between items-center p-4 bg-gray-200 md:hidden">
          <h1 className="text-lg font-bold">School's Dashboard</h1>
